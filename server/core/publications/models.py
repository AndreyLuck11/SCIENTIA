...
class Publication(models.Model):
    ...
    sources = models.TextField(blank=True, verbose_name='Источники')
    ...
    output_data = models.TextField(blank=True, verbose_name='Выходные данные')
    ...
    e_ISSN = models.TextField(blank=True, verbose_name='e-ISSN')
