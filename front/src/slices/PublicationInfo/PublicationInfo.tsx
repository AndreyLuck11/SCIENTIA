...
import { Author, PublicationDetail } from "@/interfaces/interfaces";
...
function PublicationInfo({id}: PublicationInfoProps) {

	const router = useRouter()

	const { data, isLoading, error } = useSWR<PublicationDetail>([`publications/${id}/`],
